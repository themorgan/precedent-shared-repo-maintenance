...
| [llm-neutral](practices/llm-neutral.md) | retired | — (nowhere) | **Retired 2026-09-11, by Morgan.** Reviewing this set after the 2026-09-09 subject split, this was one of two rules left in it that are not about maintaining a repository at all: it governs how you build an integration against a model provider, which is engineering craft. |
| [match-parsed-id-not-prefix](practices/match-parsed-id-not-prefix.md) | retired | — (nowhere) | **Retired 2026-09-11, by Morgan.** The same review as `llm-neutral`, on the same ground: this is a rule about writing code that matches identifiers, not a rule about maintaining a repository, and it landed here in the subject split for want of anywhere better. |
